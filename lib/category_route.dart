...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  Future<void> _retrieveApiCategory() async {
    ...
    if (_categories.last.name != apiCategory['name']) {
      setState(() {
        _categories.add(Category(
    ...
    if (jsonUnits != null) {
      ...
      setState(() {
        _categoriApiError = units.isEmpty ? true : false;
    ...
    if (deviceOrientation == Orientation.portrait) {
      return ListView.builder(
        itemBuilder: (BuildContext context, int index) {
          // ok TODO: You may want to make the Currency [Category] not tappable
...
//            onTap: _onCategoryTap,
            onTap: category.name == apiCategory['name'] &&
                    category.units.isEmpty ? null: _onCategoryTap,
          );
        },
      ...
      return GridView.count(
        ...
        children: _categories.map((Category c) {
          return CategoryTile(
            category: c,
            onTap: c.name == apiCategory['name'] &&
                c.units.isEmpty ? null : _onCategoryTap,
          );
        }).toList(),
      );
    }
