...
class _UnitConverterState extends State<UnitConverter> {
  ...
  // ok TODO: Add a flag for whether to show error UI
  ...
  Future<void> _updateConversion() async {
    ...
    if (widget.category.name == apiCategory['name']) {
      ...
      // ok TODO: Check whether to show an error UI
      if (conversion == null) {
        setState(() {
          showErrorUI = true;
        });
  ...
  Widget build(BuildContext context) {
    // ok TODO: Build an error UI

    final error = ListView(
          children: [
            AlertDialog(
              // title: Center(child: Text('Connection error')),
              content: Column(
                  children: <Widget>[
                    Icon(Icons.error_outline,
                      ...
                      size: 100.0, ),
                    Center(
                      child: Text("Oh, sorry! We can't connect right now!",
              ...
              backgroundColor: widget.category.color['error'],
    ...
    return Padding(
      ...
      child: OrientationBuilder(
        builder: (BuildContext context, Orientation orientation) {
          ...
          if (showErrorUI == true && widget.category.name == apiCategory['name'] ) {
            return error;
          }
